      ...
      <div className="container">
        <div>
          ...
          <div className="container-users">
            <div>
              <h2>15+ million</h2>
              <p>yearly visitors worldwide, unified by the love of movies</p>
            </div>
            <div>
              <h2>10+ genres</h2>
              <p>out there to search and explore your personal favorites</p>
            </div>
            <div>
              <h2>100+ movies</h2>
              <p>to rate and review the acting, directing, storytelling, etc.</p>
            </div>
            <div>
              <h2>5000+ reviews</h2>
              <p>and ratings generated by users across the world</p>
            </div>
          </div>
